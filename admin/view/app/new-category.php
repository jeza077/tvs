<div class="container-fluid py-4">
    ...
    <div class="col-lg-6 m-auto">
        <h3 class="mt-3 mb-3 text-center">Agregar nueva categoría</h3>
       
        <div class="card">

        <div class="card-body">
            <form class="multisteps-form__form" style="height: 276px;" id="categoryForm">
            <!--single form panel-->
            <div class="pt-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                ...
                <div class="multisteps-form__content">
                    <div class="mt-4">
                        ...
                        <div class="input-group input-group-dynamic">
                            ...
                            <input class="form-control" name="category" type="text" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                        </div>
                ...
                <div class="button-row d-flex mt-0 mt-md-5">
