    ...
    public function showCategories(){
        ...
        $dataJson = '{
            ...
            for($i = 0; $i < count($categories); $i++){
                ...
                $buttons = "<button class='btn btn-warning btn-xs me-1' data-toggle='tooltip' data-original-title='Editar categoría' id='btnEditCategory' idCategory='".$categories[$i]['id_categoria']."'>Editar</button><button class='btn btn-outline-danger btn-xs' data-toggle='tooltip' data-original-title='Eliminar categoría' id='btnDeleteCategory' idCategory='".$categories[$i]['id_categoria']."'>Eliminar</button>";
